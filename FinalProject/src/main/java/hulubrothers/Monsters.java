...
public class Monsters extends  Creatures {
    ...
    Monsters(int n, World world, int x, int y, int Mode) {
        super(n, world, x, y, 1, Mode);
        ...
        AppearanceUI.setFitHeight(Integer.parseInt(properties.getProperty("HeightUI1")));
        AppearanceUI.setFitWidth(Integer.parseInt(properties.getProperty("WidthUI1")));
        AppearanceUI.setX(Integer.parseInt(properties.getProperty("LayoutXUI1")) - AppearanceUI.getFitWidth() / 2);
        AppearanceUI.setY(Integer.parseInt(properties.getProperty("LayoutYUI1")) - AppearanceUI.getFitHeight() / 2);
    }
